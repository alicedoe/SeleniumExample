...
public abstract class BasePage {
	...
	// something more complicated where you have three levels and you are constantly going
	...
	//  of Selenium entirely.  It also sets up the wait object and ties it to the ready() overridden in the
	//  concrete Page class.
	...
	//  quit can be called on any concrete page class.
	...
	public ExpectedCondition<?> ready(){
		...
		List<String> handlesList = new ArrayList<>(wdResource.driver.getWindowHandles());
